...
public class MyAccountTest extends BaseTest {
	...
	public void testSendInvailCurrentPass(String email, String pass, String wrongPass, String newPass,
			String confirmPass) {
		homePage.open();
		...
		Assert.assertEquals(myAccountPage.checkInputWrongPass(), MESSAGE_ERROR_CURRENT_PASS,
				"Test wrong current password pass!");
	...
	public void testSendInvailConfirmPass(String email, String pass, String newPass, String confirmPass) {
		...
		Assert.assertEquals(myAccountPage.checkInputWrongConfirmPass(), MESSAGE_ERROR_CONFIRM_PASS,
				"Test invalid confirm password pass");
	}

	@Test(dataProvider = "data_change_billing_address")
	public void changeBillingaddress(String email, String pass, String firstName, String lastName, String company,
			String phoneNumber, String streetAddress, String city, String region, String postcode, String country) {
		homePage.open();
		if (!signInPage.existWelcomeButton()) {
			homePage.clickOnSignIn();
			signInPage.login(email, pass);
		...
		if (firstName == "") {
			...
			Assert.assertEquals(myAccountPage.requirePhoneNumber(), MESSAGE_ERROR_REQUIRE_INPUT_BILLING_ADDRESS,
					"Test require phone number passed");
	...
	public static Object[][] dataChangeInformation() {
		return new Object[][] {
				{ "huyenhoang@gmail.com", "Huyen01$", "", "Le", "SmartOsc", "0317549393", "Thanh Xuan, Nguyen Trai",
						"Ha Noi", "Ha Noi", "1000", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "", "SmartOsc", "0317549393", "Thanh Xuan, Nguyen Trai",
						"Ha Noi", "Ha Noi", "1000", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "", "Thanh Xuan, Nguyen Trai",
						"Ha Noi", "Ha Noi", "1000", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "0317549393", "", "Ha Noi", "Ha Noi",
						"1000", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "0317549393",
						"Thanh Xuan, Nguyen Trai", "", "Ha Noi", "1000", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "0317549393",
						"Thanh Xuan, Nguyen Trai", "Ha Noi", "Ha Noi", "", "VN" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "0317549393",
						"Thanh Xuan, Nguyen Trai", "Ha Noi", "Ha Noi", "1000", "" },
				{ "huyenhoang@gmail.com", "Huyen01$", "Phuong", "Le", "SmartOsc", "0317549393",
						"Thanh Xuan, Nguyen Trai", "Ha Noi", "Ha Noi", "1000", "VN" } };
	}
